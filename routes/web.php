...
Route::get('/page/creators', [CafesController::class, 'creators'])->name('creators.page');
Route::get('/musicians', [CafesController::class, 'Musicians'])->name('Musicians');
Route::get('/artists', [CafesController::class, 'Artists'])->name('Artists');
Route::get('/game', [CafesController::class, 'Game'])->name('Game');
...
Route::group(['middleware' => 'private.content'], function() {
	...
	Route::get('{slug}/{media}', [UserController::class, 'profile'])->where('media', '(photos|videos|about|shop|files)$')->name('profile');
	// Profile User
