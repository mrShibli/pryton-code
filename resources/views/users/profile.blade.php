    ...
    <div class="container">
        <div class=" d-md-block position-relative" style="">
            ...
            @if ($user->review_img)
                ...
                <div class="d-none d-lg-block position-absolute" style="height:200px; width:300px; top: 40px; left: 0px">
                    <img height="200px" width="300px" src="{{ asset('public/img/review/' . $user->review_img) }}"
                        alt="" srcset="">
                </div>
            @else
                <div class="d-none d-lg-block position-absolute" style="height:200px; width:300px; top: 40px; left: 0px">
                    <img height="200px" width="300px" src="{{ asset('public/notes.jpg') }}" alt="" srcset="">
                </div>
            @endif
            ...
            <div class="d-none d-lg-block position-absolute" style="top: 70px; right: 0px;">
                ...
                <div class="pageWrap d-flex flex-row align-items-center" style="height:100px; width:300px">
                    ...
                    <div class="sliderOute"
                        style="background-image: url('{{ asset('public/TV_BG.webp') }}');     
                            ...
                            @if ($mediaItem)
                                ...
                                <div class="slide" style="top:25px;">
                                    <img style="
                                            ...
                                            "
                                        src="{{ asset('files/storage/' . $update->id . '/' . $mediaItem->image) }}"
                                        alt="" srcset="">
                                </div>
                            @endif
                        @endforeach
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="w-100 text-center py-4 img-profile-user">
                    ...
                    @if (Helper::isCreatorLive($getCurrentLiveCreators, $user->id) && auth()->check() && auth()->id() != $user->id) avatar-wrap-live liveLink
                    @else
                        avatar-wrap @endif shadow
                    @if (
                        (auth()->check() &&
                            auth()->id() != $user->id &&
                            Cache::has('is-online-' . $user->id) &&
                            $user->active_status_online == 'yes') ||
                            (auth()->guest() && Cache::has('is-online-' . $user->id) && $user->active_status_online == 'yes')) user-online-profile overflow-visible
                    @elseif (
                        (auth()->check() &&
                            auth()->id() != $user->id &&
                            !Cache::has('is-online-' . $user->id) &&
                            $user->active_status_online == 'yes') ||
                            (auth()->guest() && !Cache::has('is-online-' . $user->id) && $user->active_status_online == 'yes'))
                        user-offline-profile overflow-visible @endif">
                    ...
                    <div class="media-body">
                        ...
                        <div class="d-flex-user justify-content-center mb-2">
                            ...
                            @if (auth()->check() && auth()->id() != $user->id && $totalPosts != 0 && $settings->disable_tips == 'off')
                                <a href="javascript:void(0);" data-toggle="modal" title="{{ __('general.tip') }}"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        fill="currentColor" class="bi-coin" viewBox="0 0 16 16">
                                        <path
                            ...
                            @if (
                                ...
                                <button
                                    @guest data-toggle="modal" data-target="#loginFormModal" @else
                ...
                @if ($user->free_subscription == 'no')
                    @foreach ($plans as $key => $plan)
                        <div class="modal fade" id="subscriptionForm{{ $plan->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modal-form{{ $plan->id }}" aria-hidden="true">
                                    ...
                                    <div class="modal-body p-0">
                                        <div class="card bg-white shadow border-0">
                                            ...
                                            <div class="card-body px-lg-5 py-lg-5 position-relative">
                                                ...
                                                @php
                                                    $pricebaby = Helper::formatPrice($user->getPlan($plan->id, 'monthly', 'price'), true);
                                                @endphp
                                            ...
                                            ' .
                                                                ...
                                                                $paymentName =
                                                                    '<img
                                                src="' .
                                                                    url('public/img/payments', auth()->user()->dark_mode == 'off' ? $payment->logo : 'paypal-white.png') .
                                                                    '"
                                                width="70" /> <small
                                                class="w-100 d-block">' .
                                                ...
                                                width="70" />' .
                                                    ...
                                                    <div class="custom-control custom-control-alternative custom-checkbox">
                                                        <input class="custom-control-input" required
                                                            id=" customCheckLogin{{ $key }}" name="agree_terms"
                                                            type="checkbox">
                                                        <label class="custom-control-label"
                                                            for=" customCheckLogin{{ $key }}">
                                                    ...
                                                    <div class="text-center">
                                                        <button type="button" onclick="initForm('{{ $key }}')"
                                                        ...
                                                        @if ($plans->count())
                                                            <a class="d-block my-3 btn-arrow-expand-bi"
                                                                data-toggle="collapse" href="#collapseSubscriptionBundles"
                                                            ...
                                                            <div class="collapse" id="collapseSubscriptionBundles">
                                                                @foreach ($plans as $plan)
                                                                    <button type="submit"
                                                                        ...
                                                                        <i></i>
                                                                        {{ __('general.subscribe_' . $plan->interval) }}
                                                                        {{ $pricebaby }}
                                                                    </button>

                                                                    @if (Helper::calculateSubscriptionDiscount(
                                                                            $plan->interval,
                                                                            $user->getPlan($plan->id, 'monthly', 'price'),
                                                                            $plan->price) > 0)
                                                                        <small
                                                                            class="@if (auth()->user()->dark_mode == 'on') text-white @else text-success @endif subscriptionDiscount">
                                                                            <em>{{ Helper::calculateSubscriptionDiscount(
                                                                                $plan->interval,
                                                                                $user->getPlan($plan->id, 'monthly', 'price'),
                                                                                $plan->price,
                                                                            ) }}%
                ...
                <div class="d-block d-md-flex d-lg-none">
                    ...
                    <div class="mx-auto d-sm-block d-lg-none">
                        @if ($user->review_img)
                            <div class="d-block mx-auto" style="height:200px; width:300px; top: 40px; left: 0px"><img
                                    height="200px" width="300px"
                                    src="{{ asset('public/img/review/' . $user->review_img) }}" alt=""
                                    srcset=""></div>
                        @else
                            <div class="d-block mx-auto" style="height:200px; width:300px; top: 40px; left: 0px"><img
                                    height="200px" width="300px" src="{{ asset('public/notes.jpg') }}" alt=""
                                    srcset=""></div>
                        @endif
                    </div>


                    <div class="pageWrap d-md-flex flex-row  d-lg-none mx-auto mt-4 mt-sm-5 mt-md-0"
                ...
                @if ($user->free_subscription == 'no')
                    @if (count($plans) > 0)
                        <h1 class="text-center mt-4 title_member" style="font-family:Noto sans-serif;">Choose your
                            membership</h1>
                    @endif
                            ...
                            <div class="row">
                                ...
                                @foreach ($plans as $key => $plan)
                                    <div class="col-xs-12 col-sm-4 col-lg-4 mx-auto">
                                        <div class="pricingTable rounded pricingTable-2 border p-0"
                                            {!! isset($key) && $key == 1 ? 'style="border-top: 0px !important;"' : '' !!}>
                                            @if (isset($key) && $key == 1)
                                                <p class="m-0"
                                        ...
                                        style="background-color: #7f28b5; width: 100%;">Join</a> --}}
                                                @auth
                                                    <a href="javascript:void(0);" data-toggle="modal"
                                                        data-target="#subscriptionForm{{ $plan->id }}"
                                                        class="btn btn-lg text-white"
                                                        style="background-color: #7f28b5; width: 100%;">
                                                        <i class="feather icon-unlock mr-1"></i>
                                                        Join
                                                        {{ __('', ['price' => $user->getPlan($plan->id, 'monthly', 'price')]) }}
                                                    </a>
                                                @else
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text position-relative">
                                    ...
                                    <small class="btn-block m-0 mb-1">
                                        ...
                                        ({{ \Carbon\Carbon::parse($user->birthdate)->age }} {{ __('general.years') }})
                                    </small>
                                    {{-- @endif --}}
                        ...
                        @if ($shopCategories->count())
                            <select class="ml-2 custom-select mb-2 mb-lg-0 w-auto filter">
                                <option @if (!request()->get('cat')) selected @endif
                                    value="{{ url($user->username, 'shop') }}">
                                    {{ __('general.all_categories') }}</option>
                        ...
                        <form method="post" action="{{url('buy/subscription')}}" id="formSubscription">
                            ...
                            <div class="custom-control custom-radio mb-3">
                                <input name="payment_gateway" required value="{{$payment->name}}"
                                    id="radio{{$payment->name}}" @if ($allPayment->count() == 1 && Helper::userWallet('balance') == 0) checked @endif class="custom-control-input"
                                type="radio">
