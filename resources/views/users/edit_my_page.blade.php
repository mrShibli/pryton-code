                                  ...
                                  <div class="row form-group mb-0">
                                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="col-lg-12">
                                            <div class="input-group mb-4 position-relative" style="border: 2px solid #cdd4da;">
                                              <p class="m-2 position-absolute">
                                                Upload Review Image *100px x 300px
                                              </p>
                                              <input class="form-control" name="review_img" value="" type="file">
                                            </div>
                                          </div><!-- ./col-md-6 -->
                                    </div><!-- End Row Form Group -->
