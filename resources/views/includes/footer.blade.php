...
<footer class="container" style="color: white">
  <div class="row">
    ...
    <div class="col-md-3">
      <b>
        <h6 class="text-uppercase" style="font-weight:900 !important;">@lang('general.about')</h6>
      </b>
    ...
    <div class="col-md-3">
      <h6 class="text-uppercase" style="font-weight:900 !important;">@lang('general.categories')</h6>
      <ul class="list-unstyled">
  ...
  @endif
    <div class="col-md-3">
      <h6 class="text-uppercase" style="font-weight:900 !important;">@lang('general.links')</h6>
      <ul class="list-unstyled">
      @guest
