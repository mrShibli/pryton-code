    ...
    <section class="section section-sm">
        <div class="container container-lg-3 pt-lg-5 pt-2">
            <div class="row">
                ...
                <div class="col-md-6 p-0 second wrap-post " style="height: 100vh ; overflow-y: auto">
                    <style>
                        @media (max-width: 991px) {

                            /* Apply styles only for small screens */
                            .col-md-6 {
                        ...
                        /* Hide the scrollbar on all devices */
                ...
                <div class="col-md-4 @if ($users->count() != 0) mb-4 @endif d-lg-block d-none">
                    <div class="d-lg-block sticky-top" style="position: unset">
                        @if ($users->count() == 0)
